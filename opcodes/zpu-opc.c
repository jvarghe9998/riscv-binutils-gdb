...
static int
match_rs1_eq_rs2 (const struct zpu_opcode *op, insn_t insn)
{
...
static int
match_rd_nonzero (const struct zpu_opcode *op, insn_t insn)
{
  return match_opcode (op, insn) && ((insn & MASK_RD) != 0);
}

static int
match_c_add (const struct zpu_opcode *op, insn_t insn)
{
  return match_rd_nonzero (op, insn) && ((insn & MASK_CRS2) != 0);
}

static int
match_c_lui (const struct zpu_opcode *op, insn_t insn)
{
